let g:coc_global_extensions = [ 'coc-tsserver', 'coc-java', 'coc-json', 'coc-yaml', 'coc-xml',  'coc-tailwindcss', 'coc-calc', 'coc-swagger', 'coc-markmap', 'coc-highlight' ]
...
source $DOTFILES/vim/plugins/markmap.vim
